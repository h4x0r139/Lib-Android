...
//		System.out.println("加密后数据: hexStr:"+Hex.encodeHexStr(encodeData));
        ...
        //        Content：123456，Password：12345678
//        AB6B3243E426F8352B45B4154711ACA13B7F3DC509E8FE65D6911E94ADCC365D
        String plain = "123456";
        String secrectKey = "12345678";

//        byte[] keys = Hmac.getHmaSHA256key();
        byte[] sign = HmacUtils.encodeHmacSHA256(plain.getBytes(), secrectKey.getBytes());
        System.out.println("sign=" + byte2hex(sign));
        System.out.println("sign2=" + showByteArray(sign));
    }
