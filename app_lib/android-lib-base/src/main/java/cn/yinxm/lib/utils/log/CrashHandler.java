...
import cn.yinxm.lib.utils.DateUtil;
import cn.yinxm.lib.utils.FileUtil;
    ...
    public void uncaughtException(Thread thread, Throwable ex) {
        ...
        if (!handleException(ex) && mDefaultHandler != null) {
            ...
            try {
                ...
                LogUtil.e("uncaught exception:" + e.getMessage());
            }
...
//        }.start();
    ...
    private void collectDeviceInfo() {
        ...
        try {
            ...
            LogUtil.e("name not found exception:" + e.getMessage());
        }
        ...
        for (Field field : fields) {
            try {
                ...
                LogUtil.e("illegal access exception:" + e.getMessage());
            }
        }
    }
    ...
    private void saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            LogUtil.e("save crash info to file exceptin:" + e.getMessage());
        }
    }
}
