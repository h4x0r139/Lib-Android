...
import static cn.yinxm.lib.api.ILoginInfo.Gender.Undefined;
...
public class DefaultLoginInfoIml implements ILoginInfo, Serializable {
    ...
    private Gender gender = Undefined;//性别
